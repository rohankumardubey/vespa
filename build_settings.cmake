...
if (APPLE)
  if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
    set(HOMEBREW_CLANG_WORKAROUND "-L${VESPA_HOMEBREW_PREFIX}/opt/llvm/lib/c++ -L${VESPA_HOMEBREW_PREFIX}/opt/llvm/lib/unwind -lunwind")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} ${HOMEBREW_CLANG_WORKAROUND}")
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${HOMEBREW_CLANG_WORKAROUND}")
  endif()
endif()
if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Darwin")
  if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang" OR "${CMAKE_CXX_COMPILER_ID}" STREQUAL "AppleClang")
